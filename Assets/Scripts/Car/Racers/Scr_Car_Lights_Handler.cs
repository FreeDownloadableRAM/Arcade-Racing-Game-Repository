...
public class Scr_Car_Lights_Handler : MonoBehaviour
{
    ...
    [SerializeField] private CarControllerAI carControllerScript;
    ...
    void Start()
    {
        ...
        carControllerScript = GetComponentInParent<CarControllerAI>();
